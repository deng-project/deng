...
add_dependencies(${OPENGL_MULTI_FRAMEBUFFER_TARGET} ${DENG_COMPLETE_TARGET})
target_link_libraries(${OPENGL_MULTI_FRAMEBUFFER_TARGET} PRIVATE ${DENG_COMPLETE_TARGET})
set_target_properties(${OPENGL_MULTI_FRAMEBUFFER_TARGET} PROPERTIES FOLDER ${MANUAL_TEST_DIR})

# Vulkan test
add_executable(${VULKAN_MULTI_FRAMEBUFFER_TARGET} ${VULKAN_MULTI_FRAMEBUFFER_SOURCES})
add_dependencies(${VULKAN_MULTI_FRAMEBUFFER_TARGET} ${DENG_COMPLETE_TARGET})
target_link_libraries(${VULKAN_MULTI_FRAMEBUFFER_TARGET} PRIVATE ${DENG_COMPLETE_TARGET})
set_target_properties(${VULKAN_MULTI_FRAMEBUFFER_TARGET} PROPERTIES FOLDER ${MANUAL_TEST_DIR})