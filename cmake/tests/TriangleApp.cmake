...
set(OGL_TRIANGLE_HEADERS tests/TriangleApp.h)
set(OGL_TRIANGLE_SOURCES tests/OpenGLTriangle.cpp)

add_executable(${OGL_TRIANGLE_TARGET} 
	${OGL_TRIANGLE_HEADERS}
...
set(VK_TRIANGLE_HEADERS tests/TriangleApp.h)
set(VK_TRIANGLE_SOURCES tests/VulkanTriangle.cpp)

add_executable(${VK_TRIANGLE_TARGET} 
	${VK_TRIANGLE_HEADERS}
	${VK_TRIANGLE_SOURCES})
