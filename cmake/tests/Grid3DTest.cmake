...
add_dependencies(${OPENGL_GRID_TEST_TARGET} ${DENG_SHARED_TARGET})
target_link_libraries(${OPENGL_GRID_TEST_TARGET} PRIVATE ${DENG_SHARED_TARGET})

# Vulkan test
add_executable(${VULKAN_GRID_TEST_TARGET} ${VULKAN_GRID_TEST_SOURCES})
add_dependencies(${VULKAN_GRID_TEST_TARGET} ${DENG_SHARED_TARGET})
target_link_libraries(${VULKAN_GRID_TEST_TARGET} PRIVATE ${DENG_SHARED_TARGET})
