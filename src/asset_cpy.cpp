...
namespace deng {
    namespace vulkan {
        ...
        AssetCpy::AssetCpy(void *udata) : m_udata(udata) {}


        void AssetCpy::cpyToBuffer(const VkDevice device, const das_Asset &asset, const VkDeviceMemory mem) {
        ...
        void AssetCpy::bufCpyVertBuffer(const VkDevice device, const VkCommandPool cmd_pool, const das_Asset &asset, 
        ...
        /************************************/
        void AssetCpy::__cpyVu2D(const VkDevice device, const das_Asset &asset, const VkDeviceMemory mem) {
        ...
        void AssetCpy::__cpyVm2D(const VkDevice device, const das_Asset &asset, const VkDeviceMemory mem) {
            // Copy position vertices
            __vk_BufferCreator::cpyToBufferMem(device, asset.vertices.v2d.mul.pn * sizeof(const das_ObjPosData2D),
                asset.vertices.v2d.mul.pos, mem, asset.offsets.pos_offset, m_udata);
        ...
        void AssetCpy::__cpyVu3D(const VkDevice device, const das_Asset &asset, const VkDeviceMemory mem) {
            // Copy position vertices
        ...
        void AssetCpy::__cpyVm3D(const VkDevice device, const das_Asset &asset, const VkDeviceMemory mem) {
            // Copy position vertices
            __vk_BufferCreator::cpyToBufferMem(device, asset.vertices.v3d.mul.pn * sizeof(const das_ObjPosData),
                asset.vertices.v3d.mul.pos, mem, asset.offsets.pos_offset, m_udata);
        ...
        /***********************************************************/
        void AssetCpy::__bufCpyVu2DToVertBuffer (
        ...
        void AssetCpy::__bufCpyVm2DToVertBuffer (
            const VkDevice device, 
            const VkCommandPool cmd_pool, 
            const das_Asset &asset,
            const VkBuffer src_buf, 
        ...
        void AssetCpy::__bufCpyVu3DToVertBuffer (
            const VkDevice device, 
            const VkCommandPool cmd_pool, 
            const das_Asset &asset,
            const VkBuffer src_buf, 
        ...
        void AssetCpy::__bufCpyVm3DToVertBuffer (
            const VkDevice device,
            const VkCommandPool cmd_pool,
            const das_Asset &asset,
            const VkBuffer src_buf,
