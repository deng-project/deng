...
/// file: VulkanResourceManager.h - Vulkan resource manager class header
...
#ifdef VULKAN_RESOURCE_MANAGER_CPP
    #include <memory>
    #include <vector>
    #include <array>
    #include <queue>
...
namespace DENG {
    namespace Vulkan {
        ...
        class ResourceManager : public BufferManager, public TextureManager {
        private:
