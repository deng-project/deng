...
// file: EditorCameraEvent.h - editor camera event class header
// author: Karl-Mihkel Ott

#ifndef EDITOR_CAMERA_EVENT_H
#define EDITOR_CAMERA_EVENT_H


#ifdef EDITOR_CAMERA_EVENT_CPP
    #include <string>
    #include <string.h>
...
namespace deng {
    ...
    class EditorCameraEvent : protected Event3DBase {
    private:
