...
// file: VulkanPipelineCreationHelper.h - Vulkan pipeline createinfo generation class header
// author: Karl-Mihkel Ott


#ifndef VULKAN_PIPELINE_CREATION_HELPER_H
#define VULKAN_PIPELINE_CREATION_HELPER_H

#ifdef VULKAN_PIPELINE_CREATION_HELPER_CPP
    #include <vector>
    #include <array>
    #include <string>
    #include <queue>
...
namespace DENG {
    namespace Vulkan {
        ...
        class PipelineCreateInfoGenerator : private __vk_PipelineCreateInfoSpecifiers {
        private:
            VkDevice m_device;
            VkExtent2D m_ext;
