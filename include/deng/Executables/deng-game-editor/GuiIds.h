...
namespace DENG {
	namespace Editor {
		...
		enum GuiIDs {
			...
			/** RenameDialog **/
			ID_RENAME_DIALOG,
			ID_RENAME_DIALOG_CTRL,
			ID_RENAME_DIALOG_OK,
			ID_RENAME_DIALOG_CANCEL,
			/** End of RenameDialog **/

			/** FileController **/
			ID_FILE_CONTROLLER,
			ID_FILE_CONTROLLER_MENU,
			ID_FILE_CONTROLLER_MENU_OPEN,
			ID_FILE_CONTROLLER_MENU_OPEN_WITH,
			ID_FILE_CONTROLLER_MENU_ADD_FILE,
			ID_FILE_CONTROLLER_MENU_ADD_FOLDER,
			ID_FILE_CONTROLLER_MENU_COPY,
			ID_FILE_CONTROLLER_MENU_CUT,
			ID_FILE_CONTROLLER_MENU_PASTE,
			ID_FILE_CONTROLLER_MENU_DELETE,
			ID_FILE_CONTROLLER_MENU_RENAME,
			ID_FILE_CONTROLLER_MENU_DOS_SHELL,
			ID_FILE_CONTROLLER_MENU_PROPERTIES,
