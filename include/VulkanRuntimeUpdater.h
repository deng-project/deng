...
/// file: VulkanRuntimeUpdater.h - Vulkan runtime buffer data update class header
/// author: Karl-Mihkel Ott


#ifndef VULKAN_RUNTIME_UPDATER_H
#define VULKAN_RUNTIME_UPDATER_H

#ifdef VULKAN_RUNTIME_UPDATER_CPP
    #include <string.h>
    #include <memory>
    #include <vector>
    #include <array>
