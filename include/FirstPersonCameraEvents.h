...
// file: FirstPersonCameraEvents.h - First person camera event class header
// author: Karl-Mihkel Ott

#ifndef FIRST_PERSON_CAMERA_EVENTS_H
#define FIRST_PERSON_CAMERA_EVENTS_H


#ifdef FIRST_PERSON_CAMERA_EVENTS_CPP
    #include <string>
    #include <string.h>
    #include <iostream>
    #include <chrono>
...
namespace DENG {
    ...
    class FirstPersonCameraEvents : protected __Event3DBase {
    private:
